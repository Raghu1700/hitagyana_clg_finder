...
class AppTheme {
  ...
  // New Color Palette - Warm Terracotta
  static const Color primaryLight = Color(0xFFE39A7B); // Terracotta - Main actions
  static const Color primaryVariantLight = Color(0xFFDBB06B); // Gold - Accents
  static const Color secondaryLight = Color(0xFFFFB5AB); // Rosy Pink - Selections
  static const Color secondaryVariantLight = Color(0xFFFFD3AC); // Light Peach - Surfaces
  ...
  static const Color warningLight = Color(0xFFD97706); // Balanced orange
  static const Color accentLight = Color(0xFFFFB5AB); // Rosy pink
  ...
  static const Color primaryDark = Color(0xFFE39A7B); // Terracotta
  static const Color primaryVariantDark = Color(0xFFDBB06B); // Gold
  static const Color secondaryDark = Color(0xFFFFB5AB); // Rosy Pink
  static const Color secondaryVariantDark = Color(0xFFFFD3AC); // Light Peach
  ...
  // Text colors - Educational hierarchy
  ...
  /// Light theme for educational mobile application
  static ThemeData lightTheme = ThemeData(
    ...
    // Card theme - Clean information containers
    cardTheme: CardTheme(
    ...
    // Bottom navigation - Adaptive navigation pattern
  ...
  /// Dark theme for educational mobile application
