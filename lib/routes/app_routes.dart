...
class AppRoutes {
  ...
  static const String extracurricularClassesScreen = '/extracurricular-classes-screen';
  ...
  static Map<String, WidgetBuilder> routes = {
    ...
    extracurricularClassesScreen: (context) => const ExtracurricularClassesScreen(),
