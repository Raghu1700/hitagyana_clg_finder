...
class CollegeCardWidget extends StatelessWidget {
  ...
  Widget _buildRankingBadge() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: AppTheme.primaryVariantLight.withOpacity(0.2),
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: AppTheme.primaryVariantLight, width: 1),
      ),
      child: Row(
  ...
  Widget _buildCourseChips() {
    final courses = college["courses"] as List<String>;
    return Wrap(
      spacing: 2.w,
      runSpacing: 1.h,
